...
var id;
	...
	function startSentiment() {          //fn to start sentimental songs 
        ...
        var name = '#song' + (i+1);
        var song = $(name);
		changeCurrentSongDetails(sentiment[0]);
    ...
    for(var i =0; i < sads.length;i++) {
        ...
        var name = '#song' + (i+1);
        var song = $(name);
		 changeCurrentSongDetails(sads[0]);
        song.find('.song-name').text(obj.name);
        song.find('.song-artist').text(obj.artist);
        song.find('.song-album').text(obj.album);
        song.find('.song-length').text(obj.duration);
    ...
    for(var i =0; i < romance.length;i++) {
        ...
        var name = '#song' + (i+1);
        var song = $(name);
		 changeCurrentSongDetails(romance[0]);
        song.find('.song-name').text(obj.name);
        song.find('.song-artist').text(obj.artist);
        song.find('.song-album').text(obj.album);
        song.find('.song-length').text(obj.duration);
    ...
    for(var i =0; i < gymers.length;i++) {
        ...
        var name = '#song' + (i+1);
        var song = $(name);
		changeCurrentSongDetails(gymers[0]);
        song.find('.song-name').text(obj.name);
        song.find('.song-artist').text(obj.artist);
        song.find('.song-album').text(obj.album);
        song.find('.song-length').text(obj.duration);
    ...
    for(var i =0; i < optimistic.length;i++) {
        ...
        var name = '#song' + (i+1);
        var song = $(name);
		changeCurrentSongDetails(optimistic[0]);
        song.find('.song-name').text(obj.name);
        song.find('.song-artist').text(obj.artist);
        song.find('.song-album').text(obj.album);
        song.find('.song-length').text(obj.duration);
...
$('.fa-volume-up').on('click',function() {
	...
	$('#audio-source').attr('src', 'sentimental1.mp3');
	startSentiment();
});
